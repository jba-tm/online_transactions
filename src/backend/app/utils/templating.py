...
from app.utils.translation import gettext_lazy as _, get_locale_code
...
class SilentUndefined(jinja2.Undefined):
    """
    Don't break page loads because vars arent there!
    """
...
class Jinja2Templates(BaseJinja2Templates):
    def _create_env(self, directory: str) -> "jinja2.Environment":
        ...
        env = jinja2.Environment(
            loader=loader, autoescape=True, undefined=SilentUndefined,
            # enable_async=True,
